...
ALTER TABLE `compra`
  ...
  ADD CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`codigo_usuario`) REFERENCES `usuario` (`codigo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `movimientos`
  ADD CONSTRAINT `movimientos_ibfk_1` FOREIGN KEY (`codigo_usuario`) REFERENCES `usuario` (`codigo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `pagos`
  ...
  ADD CONSTRAINT `pagos_ibfk_3` FOREIGN KEY (`codigo_moneda`) REFERENCES `moneda` (`codigo_moneda`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pagos_ibfk_4` FOREIGN KEY (`codigo_banco`) REFERENCES `banco` (`codigo_banco`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pagos_ibfk_5` FOREIGN KEY (`codigo_metodo`) REFERENCES `metodo_pago` (`codigo_metodo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pagos_ibfk_6` FOREIGN KEY (`codigo_referencia`) REFERENCES `referencia` (`referencia`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`codigo_usuario`) REFERENCES `usuario` (`codigo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`codigo_cliente`) REFERENCES `cliente` (`codigo_cliente`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `producto_insumo`
  ...
  ADD CONSTRAINT `producto_insumo_ibfk_3` FOREIGN KEY (`codigo_medida`) REFERENCES `unidad_medida` (`codigo_media`) ON DELETE CASCADE ON UPDATE CASCADE;
