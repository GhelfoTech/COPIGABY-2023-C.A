            ...
            <?php if(!empty($roles)): foreach ($roles as $r): ?>
              <tr class="hover:bg-gray-50/80 transition-colors">
                ...
                <td class="px-6 py-4 text-center flex justify-center gap-2">
                  <button onclick='openEditModal(<?= json_encode($r) ?>)' class="group relative text-blue-400 hover:text-blue-600 p-2 transition-colors">
                  ...
                  <button onclick="eliminar(<?= $r['codigo_rol'] ?>)" class="group relative text-red-400 hover:text-red-600 p-2 transition-colors">
